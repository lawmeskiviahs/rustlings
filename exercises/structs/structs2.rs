...
mod tests {
    ...
    fn your_order() {
        ...
        // this way is called the update syntax for defining new structs
        // here we create a new instance with updated values
        ...
        // could alse be done this way but the above way is faster
        // here we make an instance with outdated values and then update the values
